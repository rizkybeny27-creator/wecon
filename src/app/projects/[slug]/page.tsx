      ...
      <section className="px-6 md:px-12 py-20 max-w-[1600px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24">
          ...
          <div className="lg:col-span-8">
            <div 
              className="prose prose-lg max-w-none text-black/80 prose-headings:font-medium prose-headings:tracking-tight prose-headings:text-black prose-p:leading-relaxed prose-a:text-blue-600 mb-16"
